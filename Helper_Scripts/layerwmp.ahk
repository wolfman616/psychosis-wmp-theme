#NoEnv ; (MW:2022) (MW:2022) helper for wmp skin mouse-desktop interaction
#NoTrayicon
SetBatchLines,	-1
#Persistent
...
mouseh() {
	...
	if(!globalinit) {
		...
		winset,top,, ahk_class WMP Skin Host
	} settimer,resetstylecheck,500
}
...
loop,3
	DllCall("dwmapi\DwmExtendFrameIntoClientArea","uint",hwnd%a_index%,"uint",&rect0)
	, uiband_set(hwnd%a_index%)
return,
